...
function () {
  ...
  _createClass(HawkClient, [{
    ...
    value: function autocomplete(request, cancellationToken) {
      var result;
      return regenerator.async(function autocomplete$(_context4) {
        while (1) {
...
function useHawkState(initialSearch) {
  ...
  function pinItem(request, cancellationToken) {
    return regenerator.async(function pinItem$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
  ...
  function updatePinOrder(request, cancellationToken) {
    return regenerator.async(function updatePinOrder$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
...
function SearchBoxBase(_ref) {
  ...
  function handleStateChange(state, changes) {
    ...
    changes.type === '__autocomplete_mouseup__' || changes.type === '__autocomplete_keydown_enter__' || changes.type === '__autocomplete_click_item__') {
      ...
      return _objectSpread$5({}, changes, {
...
function SearchResultsLabel() {
  ...
  }, React__default.createElement("h3", null, pendingSearch.Keyword ? t('Search Results for') + ' ' + decodeURIComponent(pendingSearch.Keyword) : t('Search Results')));
}
...
export { AuthToken$1 as AuthToken, Checkbox, ConfigProvider, ContentType, Facet$1 as Facet, FacetList, FacetRail, FacetSelectionState, FacetType, GlobalSearchBox, HawkSearch, Link, Nested as NestedCheckbox, OpenRange, Pagination$1 as Pagination, PlaceholderItem, QueryStringListener, RedirectURLListener, ResultImage, ResultListing, Results, RuleOperatorType, RuleType, Search, SearchBox, SearchResultsLabel, Selections$1 as Selections, Slider, Sorting$1 as Sorting, Spinner, StoreProvider, Suggestion, SuggestionType, Swatch$1 as Swatch, SwatchItem, ToolRow, TrackingEvent$1 as TrackingEvent, checkIfUrlRefsLandingPage, createGuid, getCookie, getSearchQueryString, getVisitExpiry, getVisitorExpiry, parseLocation, parseSearchQueryString, setCookie, i18next as tConfig, useFacet, useHawkSearch };
