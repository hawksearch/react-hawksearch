 ...
 * @returns
 */
class RightChevronSVG extends React.Component<RightChevronSVGProps> {
	constructor(props) {
		super(props);
	}

	public static defaultProps: Partial<RightChevronSVGProps> = {
		class: '',
	};

	public render() {
		return (
			<svg viewBox="0 0 19 32" className={'icon ' + this.props.class} focusable="false" aria-hidden="true">
